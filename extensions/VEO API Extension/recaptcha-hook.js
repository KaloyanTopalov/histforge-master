...
(function() {
  ...
  if (!realGrecaptcha) {
    ...
    Object.defineProperty(window, 'grecaptcha', {
      ...
      set: function(val) {
        console.log('[VEO-HOOK] grecaptcha being set!', val ? Object.keys(val) : 'null');
        realGrecaptcha = val;
  ...
  function hookEnterprise(obj) {
    ...
    Object.defineProperty(obj, 'enterprise', {
      ...
      set: function(val) {
        console.log('[VEO-HOOK] grecaptcha.enterprise being set!');
        realEnterprise = val;
        if (val?.execute) {
          wrapExecute(val);
        }
  ...
  function wrapExecute(enterprise) {
    ...
    enterprise.execute = function(siteKey, options) {
      ...
      console.log('%c[VEO-HOOK] grecaptcha.enterprise.execute called!', 'background: #e74c3c; color: white; font-size: 14px;');
      console.log('[VEO-HOOK]   siteKey:', siteKey);
      console.log('[VEO-HOOK]   action:', action);
      console.log('[VEO-HOOK]   options:', JSON.stringify(options));
    ...
    console.log('[VEO-HOOK] grecaptcha.enterprise.execute wrapped successfully!');
  }

  console.log('[VEO-HOOK] reCAPTCHA hook installed (document_start)');
})();
