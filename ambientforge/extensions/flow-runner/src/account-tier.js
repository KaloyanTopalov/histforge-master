...
// "ultra.fast" | "ultra.quality" | "ultra.lower", with each entry holding
// per-aspect r2v variants that collapse to a single r2v field on return.
//
...
const MODEL_MATRIX = {
  ...
  'ultra.lower': {
    ...
    r2v_portrait: 'veo_3_1_r2v_fast_portrait_ultra_relaxed',
    r2v_landscape: 'veo_3_1_r2v_fast_landscape_ultra_relaxed',
    i2v: 'veo_3_1_i2v_s_fast_ultra_relaxed',
    i2v_fl: 'veo_3_1_i2v_s_fast_ultra_relaxed_fl',
    paygateTier: 'PAYGATE_TIER_TWO'
  }
};
...
function resolveModelMatrixKey(accountTier, qualitySetting) {
  ...
  if (qualitySetting === 'lower') return 'ultra.lower';
  return 'ultra.fast';
}
