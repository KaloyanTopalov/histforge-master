...
async function runFramesToVideo(task, ctx) {
  ...
  if (hasEndFrame) {
    ...
    safeLog('VEO Lite frames, using StartImage endpoint');
    ...
    safeLog('Only start frame, using ReferenceImages endpoint');
  ...
  safeLog('Frames-to-video, start:', startImageId, 'end:', endImageId, 'model:', videoModelKey);
